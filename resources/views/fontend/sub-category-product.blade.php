            ...
            <div class='row'>
                                            ...
                                            <div class="accordion-group">
                                                ...
                                                <div class="accordion-body collapse" id="collapse{{ $cat->id }}"
                                                    ...
                                                    <div class="accordion-inner">
                                                        @php
                                                            $sucategories = App\Models\Subcategory::where('category_id', $cat->id)
                ...
                <div class='col-md-9'>
                                            ...
                                            <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                <select class="form-control" name="" id="sortBy">
                                                    ...
                                                    <option value="priceHightoLow"
                                                        {{ $sort == 'priceHightoLow' ? 'selected' : '' }}>Price:Higher
                                                        to Lower</option>
                                                    <option value="nameAtoZ"
                                                        {{ $sort == 'nameAtoZ' ? 'selected' : '' }}>Product Name:A to Z
                                                    </option>
                                                    <option value="nameZtoA"
                                                        {{ $sort == 'nameZtoA' ? 'selected' : '' }}>Product Name:Z to A
                                                    </option>
                                                </select>
                    ...
                    <div class="ajax-loadmore-product text-center" style="display: none">
                        <img src="{{ asset('fontend/assets/images/ajaxloader.gif') }}"
