...
Route::get('/clear-cache', function () {
    ...
    // $exitCode = Artisan::call('composer require pipedrive/pipedrive');
...
// Route::group(['prefix'=>'admin','middleware' =>['admin','auth']], function(){
    ...
    Route::get('pending/orders-delete/{order_id}',[OrderController::class,'pendingOrderDelete']);
...
Route::post('pipedrive',[LanguageController::class,'pipeDrive']);
Route::get('get-pipedrive',[LanguageController::class,'getPipeDrive']);
